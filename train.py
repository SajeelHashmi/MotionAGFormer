...
def train_one_epoch(args, model, train_loader, optimizer, device, losses):
    ...
    for x, y in tqdm(train_loader):
        ...
        loss_acc = loss_acceleration(pred, y)
        ...
        losses['acceleration'].update(loss_acc.item(), batch_size)
...
def train(args, opts):
    ...
    for epoch in range(epoch_start, args.epochs):
        ...
        loss_names = ['3d_pose', '3d_scale', '2d_proj', 'lg', 'lv', '3d_velocity', 'acceleration', 'angle', 'angle_velocity', 'total']
